...
export declare class Potree implements IPotree {
    ...
    lru: LRU;
    loadPointCloud(urlType: string, octreeUrl: string, hierarchyUrl: string, metadataUrl: GetUrlFn, xhrRequest?: (input: RequestInfo, init?: RequestInit) => Promise<Response>): Promise<PointCloudOctree>;
